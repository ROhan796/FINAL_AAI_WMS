...
import { Plus, X, AlertTriangle, Clock, CheckCircle,
  RefreshCw, Eye, ChevronDown, Filter, Search, Shield, Check, CheckCheck } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center gap-1.5 text-slate-500 hover:text-slate-700 disabled:opacity-50 text-sm px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors border-none bg-transparent cursor-pointer"
        >
